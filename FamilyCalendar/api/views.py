...
from api.models import Calendar, Appointment, Day
...
class Appointments:
    ...
    def createAppointment(response):
        ...
        return render(response, 'gui/createAppointment.html', {'form': form})
    ...
    def appointment(response, id: int) -> render:
        ...
        return render(response, 'gui/appointment.html', {'appointment': appointment, 'name': appointment.name})
